...
* source setup.gen.sh
* python batch_generate.py -n lep[had/inc/el/mu]
* bjobs -w
* python check_generate.py -n lep[had/inc/el/mu]

-----------------------------
To transform to TRUTH0 ntules:
* python batch_transform.py -n lep[had/inc/el/mu] -f TRUTH0
* bjobs -w
* python check_transform.py -n lep[had/inc/el/mu] -f TRUTH0

--------------------------------------------------------
To make a simple hard-process tree from the TRUTH0 files:
* python batch_analysis0.py -n lep[had/inc/el/mu]
* bjobs -w
* python check_analysis0.py -n lep[had/inc/el/mu] -r no[yes]
* python src/Test.Merged.py -n lep[had/inc/el/mu]
...
* python batch_transform.py -n lep[had/inc/el/mu] -f TRUTH1
* bjobs -w
* python check_transform.py -n lep[had/inc/el/mu] -f TRUTH1
